...
class TranslationMemoryPolicy
{
     ...
     */
    public function restore(User $user, TranslationMemory $translationMemory): bool
    {
        //
    }
     ...
     */
    public function forceDelete(User $user, TranslationMemory $translationMemory): bool
    {
        //
    }
    ...
    public static function scope() {
        return new Scope\TranslationMemoryScope();
    }
}
...
class TranslationMemoryScope implements IScope {
    /**
